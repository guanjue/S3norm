...
### get TSnorm & raw bw
time paste ~/scratch/vision/all_final_data/200_noblack.11_22_2017.bed $ct'.'$mk'.meanrc.txt' $ct'.'$mk'.meanrc.TSnorm.txt' $ct'.'$mk'.meanrc.MAnorm.txt' $ct'.'$mk'.meanrc.QTnorm.txt' $ct'.'$mk'.meanrc.POIS.txt' | sort -k1,1 -k2,2n > $ct'.'$mk'.meanrc.raw.Xnorm.txt'
