...
#		time macs2 bdgpeakcall -i $ct'.'$mk'.meanrc.'$type'.macs2pk.logLR.txt' -o $ct'.'$mk'.meanrc.'$type'.macs2pk.logLR.'$t'.txt' -c $t
#		mv $ct'.'$mk'.meanrc.'$type'.macs2pk.logLR.'$t'.txt' $ct'_'$mk'_macs_pk/'
...
#                mv $ct'.'$mk'.meanrc.'$type'.macs2pk.qpois.'$t'.txt' $ct'_'$mk'_macs_pk/'
                time macs2 bdgpeakcall -i $ct'.'$mk'.meanrc.'$type'.sort.NBP.bedgraph' -o $ct'.'$mk'.meanrc.'$type'.macs2pk.NBP.'$t'.txt' -c $t
                mv $ct'.'$mk'.meanrc.'$type'.macs2pk.NBP.'$t'.txt' $ct'_'$mk'_macs_pk/'
#		time macs2 bdgpeakcall -i $ct'.'$mk'.meanrc.'$type'.sort.ubg.NBP.bedgraph' -o $ct'.'$mk'.meanrc.'$type'.macs2pk.ubg.NBP.'$t'.txt' -c $t
#		mv $ct'.'$mk'.meanrc.'$type'.macs2pk.ubg.NBP.'$t'.txt' $ct'_'$mk'_macs_pk/'
                time macs2 bdgpeakcall -i $ct'.'$mk'.meanrc.'$type'.sort.NBQ.bedgraph' -o $ct'.'$mk'.meanrc.'$type'.macs2pk.NBQ.'$t'.txt' -c $t
                mv $ct'.'$mk'.meanrc.'$type'.macs2pk.NBQ.'$t'.txt' $ct'_'$mk'_macs_pk/'
#		time macs2 bdgpeakcall -i $ct'.'$mk'.meanrc.'$type'.sort.ubg.NBQ.bedgraph' -o $ct'.'$mk'.meanrc.'$type'.macs2pk.ubg.NBQ.'$t'.txt' -c $t
#                mv $ct'.'$mk'.meanrc.'$type'.macs2pk.ubg.NBQ.'$t'.txt' $ct'_'$mk'_macs_pk/'
	done
done
