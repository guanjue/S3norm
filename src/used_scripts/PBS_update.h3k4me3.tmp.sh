...
### get S3norm
#time python ~/group/software/S3norm/src/s3norm.py -r 'ERY_fl.h3k4me3.meanrc.txt' -t $ct'.'$mk'.meanrc.txt' -m 1 -i 2 -f 0.05 -n 10000 -l 100000 -a 10000 -b 0 -s /storage/home/gzx103/group/software/S3norm/src/ -p z -c F
time python ~/group/software/S3norm/src/s3norm_cpkbg.py -r 'ERY_fl.h3k4me3.meanrc.txt' -t $ct'.'$mk'.meanrc.txt' -m 1 -i 2 -f 0.1 -n 10000 -l 10000 -a 2000 -b 0 -s /storage/home/gzx103/group/software/S3norm/src/ -p z -c F -k h3k4me3_commonpk.txt.cpk.txt -g h3k4me3_commonpk.txt.cbg.txt
