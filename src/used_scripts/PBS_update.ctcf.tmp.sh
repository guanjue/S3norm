...
### get TSnorm
#time Rscript TSnorm_rc.R 'HPC7.ctcf.meanrc.txt' $ct'.'$mk'.meanrc.txt' $ct'.'$mk'.meanrc.TSnorm.txt'
### get MAnorm
#time Rscript MAnorm_rc.R 'HPC7.ctcf.meanrc.txt' $ct'.'$mk'.meanrc.txt' $ct'.'$mk'.meanrc.MAnorm.txt'
### get QTnorm
#time Rscript QTnorm_rc.R 'HPC7.ctcf.meanrc.txt' $ct'.'$mk'.meanrc.txt' $ct'.'$mk'.meanrc.QTnorm.txt'
### get POIS
#time Rscript POIS_rc.R 'HPC7.ctcf.meanrc.txt' $ct'.'$mk'.meanrc.txt' $ct'.'$mk'.meanrc.POIS.txt'
### get Z
#time Rscript Z_rc.R 'HPC7.ctcf.meanrc.txt' $ct'.'$mk'.meanrc.txt' $ct'.'$mk'.meanrc.Z.txt'
### get S3norm
time python ~/group/software/S3norm/src/s3norm.py -r 'HPC7.ctcf.meanrc.txt' -t $ct'.'$mk'.meanrc.txt' -m 1 -i 2 -f 0.05 -n 10000 -l 100000 -a 1000 -b 0 -s /storage/home/gzx103/group/software/S3norm/src/ -p z -c F
...
### get S3norm NBP
time python ~/group/software/S3norm/src/s3norm.py -r 'HPC7.ctcf.fisher_p.txt' -t $ct'.'$mk'.fisher_p.txt' -m 1 -i 2 -f 0.05 -n 10000 -l 10000 -a 100 -b 0 -s /storage/home/gzx103/group/software/S3norm/src/ -p p -c F
