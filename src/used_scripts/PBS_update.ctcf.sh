...
### get S3norm
time python ~/group/software/S3norm/src/s3norm.py -r 'HPC7.ctcf.meanrc.txt' -t $ct'.'$mk'.meanrc.txt' -m 1 -i 2 -f 0.05 -n 10000 -l 10000 -a 1000 -b 0 -s /storage/home/gzx103/group/software/S3norm/src/ -p z -c F
...
### get S3norm NBP
time python ~/group/software/S3norm/src/s3norm.py -r 'HPC7.ctcf.fisher_p.txt' -t $ct'.'$mk'.fisher_p.txt' -m 1 -i 2 -f 0.05 -n 100000 -l 10000 -a 100 -b 0 -s /storage/home/gzx103/group/software/S3norm/src/ -p p -c F
