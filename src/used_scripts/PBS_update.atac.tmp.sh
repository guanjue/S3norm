...
### get TSnorm
#time Rscript TSnorm_rc.R 'MK_imm_ad.atac.meanrc.txt' $ct'.'$mk'.meanrc.txt' $ct'.'$mk'.meanrc.TSnorm.txt'
### get MAnorm
time Rscript MAnorm_rc.R 'MK_imm_ad.atac.meanrc.txt' $ct'.'$mk'.meanrc.txt' $ct'.'$mk'.meanrc.MAnorm.txt' atac_commonpk.txt.cpk.txt
### get QTnorm
#time Rscript QTnorm_rc.R 'MK_imm_ad.atac.meanrc.txt' $ct'.'$mk'.meanrc.txt' $ct'.'$mk'.meanrc.QTnorm.txt'
### get POIS
#time Rscript POIS_rc.R 'MK_imm_ad.atac.meanrc.txt' $ct'.'$mk'.meanrc.txt' $ct'.'$mk'.meanrc.POIS.txt'
### get Z
#time Rscript Z_rc.R 'MK_imm_ad.atac.meanrc.txt' $ct'.'$mk'.meanrc.txt' $ct'.'$mk'.meanrc.Z.txt'
### get S3norm
#time python ~/group/software/S3norm/src/s3norm.py -r 'MK_imm_ad.atac.meanrc.txt' -t $ct'.'$mk'.meanrc.txt' -m 1 -i 2 -f 0.05 -n 2000 -l 2000 -a 1000 -b 0 -s /storage/home/gzx103/group/software/S3norm/src/ -p z -c F
time python ~/group/software/S3norm/src/s3norm_cpkbg.py -r 'MK_imm_ad.atac.meanrc.txt' -t $ct'.'$mk'.meanrc.txt' -m 1 -i 2 -f 0.1 -n 10000 -l 10000 -a 2000 -b 0 -s /storage/home/gzx103/group/software/S3norm/src/ -p z -c F -k atac_commonpk.txt.cpk.txt -g atac_commonpk.txt.cbg.txt
...
### get NBP
# get nbp
#time Rscript ~/group/software/S3norm/src/negative_binomial_p_2r_bgadj_bayes.R $sig1 /storage/home/g/gzx103/group/projects/vision/raw_5end/ atac.1.input.txt /storage/home/gzx103/scratch/vision/all_final_data/rc_norm/ $sig1
#time Rscript ~/group/software/S3norm/src/negative_binomial_p_2r_bgadj_bayes.R $sig2 /storage/home/g/gzx103/group/projects/vision/raw_5end/ atac.1.input.txt /storage/home/gzx103/scratch/vision/all_final_data/rc_norm/ $sig2
...
### get S3norm NBP
time python ~/group/software/S3norm/src/s3norm.py -r 'MK_imm_ad.atac.fisher_p.txt' -t $ct'.'$mk'.fisher_p.txt' -m 1 -i 2 -f 0.1 -n 10000 -l 10000 -a 100 -b 0 -s /storage/home/gzx103/group/software/S3norm/src/ -p p -c F

### get TSnorm & raw bw
time paste ~/group/projects/vision/merged_input/200_noblack.11_22_2017.bed $ct'.'$mk'.meanrc.txt' $ct'.'$mk'.meanrc.TSnorm.txt' $ct'.'$mk'.meanrc.MAnorm.txt' $ct'.'$mk'.meanrc.QTnorm.txt' $ct'.'$mk'.meanrc.POIS.txt' $ct'.'$mk'.meanrc.Z.txt' $ct'.'$mk'.meanrc.S3norm.txt' $ct'.'$mk'.fisher_p.txt' $ct'.'$mk'.s3norm.txt' | sort -k1,1 -k2,2n > $ct'.'$mk'.meanrc.raw.Xnorm.txt'
time cut -f1,2,3,4 $ct'.'$mk'.meanrc.raw.Xnorm.txt' | awk -F '\t' -v OFS='\t' '{if ($4<=2000) print $1,$2,$3,$4; else print $1,$2,$3,2000}' > $ct'.'$mk'.meanrc.raw.sort.txt'
time cut -f1,2,3,5 $ct'.'$mk'.meanrc.raw.Xnorm.txt' | awk -F '\t' -v OFS='\t' '{if ($4<=2000) print $1,$2,$3,$4; else print $1,$2,$3,2000}' > $ct'.'$mk'.meanrc.TSnorm.sort.txt'
time cut -f1,2,3,6 $ct'.'$mk'.meanrc.raw.Xnorm.txt' | awk -F '\t' -v OFS='\t' '{if ($4<=2000) print $1,$2,$3,$4; else print $1,$2,$3,2000}' > $ct'.'$mk'.meanrc.MAnorm.sort.txt'
time cut -f1,2,3,7 $ct'.'$mk'.meanrc.raw.Xnorm.txt' | awk -F '\t' -v OFS='\t' '{if ($4<=2000) print $1,$2,$3,$4; else print $1,$2,$3,2000}' > $ct'.'$mk'.meanrc.QTnorm.sort.txt'
#time cut -f1,2,3,8 $ct'.'$mk'.meanrc.raw.Xnorm.txt' | awk -F '\t' -v OFS='\t' '{if ($4<=2000) print $1,$2,$3,$4; else print $1,$2,$3,2000}' > $ct'.'$mk'.meanrc.POIS.sort.txt'
#time cut -f1,2,3,9 $ct'.'$mk'.meanrc.raw.Xnorm.txt' | awk -F '\t' -v OFS='\t' '{if ($4<=2000) print $1,$2,$3,$4; else print $1,$2,$3,2000}' > $ct'.'$mk'.meanrc.Z.sort.txt'
time cut -f1,2,3,10 $ct'.'$mk'.meanrc.raw.Xnorm.txt' | awk -F '\t' -v OFS='\t' '{if ($4<=2000) print $1,$2,$3,$4; else print $1,$2,$3,2000}' > $ct'.'$mk'.meanrc.S3norm.sort.txt'
#time cut -f1,2,3,11 $ct'.'$mk'.meanrc.raw.Xnorm.txt' | awk -F '\t' -v OFS='\t' '{if ($4<=2000) print $1,$2,$3,$4; else print $1,$2,$3,2000}' > $ct'.'$mk'.meanrc.NBP.sort.txt'
#time cut -f1,2,3,12 $ct'.'$mk'.meanrc.raw.Xnorm.txt' | awk -F '\t' -v OFS='\t' '{if ($4<=2000) print $1,$2,$3,$4; else print $1,$2,$3,2000}' > $ct'.'$mk'.meanrc.S3norm_NBP.sort.txt'
### get bw
